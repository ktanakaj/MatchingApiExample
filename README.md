...
（デバッグ実行時は「[マルチスタートアッププロジェクト](https://learn.microsoft.com/ja-jp/visualstudio/ide/how-to-set-multiple-startup-projects?view=visualstudio)」に設定すると便利です。）
...
部屋では「早押しゲーム」で対戦できます。「早押しゲーム」の勝敗に応じてプレイヤーのレーティング値が変動します。
